          ...
          <tbody className="bg-slate-700 divide-y divide-slate-600">
            {schools.map((school, index) => (
              <tr key={index} className="hover:bg-slate-650 transition-colors duration-150">
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-slate-100">{school.name}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-300">{school.address}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-300">{school.type}</td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-300 text-right">{school.studentCount.toLocaleString()}</td>
              </tr>
            ))}
          </tbody>
        </table>
